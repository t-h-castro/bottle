...
Maybe another way to approach this:

Take the top 10 phylum across all four samples, make a list of them, and then pull the ACTUAL numbers of those ten for all four samples.
...
Now, pull only the ones on this list as our dataset:
...
Make it wide for the chi-square/anova
